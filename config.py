...
misc_arg.add_argument('--backbone', type=str, default='resnet32',
                      help='Backbone network arch')

# Spaced-KD params
misc_arg.add_argument('--space_interval', type=float, default=-1,
                      help='Spaced-KD interval (epochs). -1 for disable')
